...
#' @examples
#' app_isNew2()
app_isNew2  <- function(token = '36F0DB19-AC55-4062-B2DA-39DC39B297BE',app_name ='appTpl') {
...
#' @examples
#' app_create2()
app_create2 <- function(token = '36F0DB19-AC55-4062-B2DA-39DC39B297BE',app_name ='appTpl') {
  flag_new = app_isNew2(token=token,app_name = app_name)
  if(flag_new){
    #创建默认用户
    #conn = tsda::sql_getConn(token = '36F0DB19-AC55-4062-B2DA-39DC39B297BE')
    sql_user =  paste0("insert into t_md_userRight
